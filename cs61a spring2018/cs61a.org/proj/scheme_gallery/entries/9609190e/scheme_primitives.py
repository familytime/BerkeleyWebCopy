...
def scheme_div(val0, *vals):
    ...
    try:
        ...
        raise SchemeError(str(err) + ";; {},{}".format(val0, *vals))
...
def scheme_quo(val0, val1):
    ...
    try:
        ...
        raise SchemeError(err + ";; {},{}".format(val0, val1))
...
@primitive("turtle-distance")
def scheme_turtle_distance(x, y):
    """ Uses Turtle function distance to return distance from turtle's current
        position to the provided coordinates """
    _check_nums(x, y)
    _tscheme_prep()
    return turtle.distance(x, y)

@primitive("turtle-angle")
def scheme_turtle_angle(x, y):
    """ Uses Turtle function distance to return angle from turtle's current
        position to the provided coordinates """
    _check_nums(x,y)
    _tscheme_prep()
...
@primitive("goto")
def scheme_turtle_goto(x, y):
    _check_nums(x,y)
    _tscheme_prep()
    return turtle.goto(x,y)

@primitive("xcor")
def scheme_turtle_xcor():
    _tscheme_prep()
    return turtle.xcor()


@primitive("ycor")
def scheme_turtle_ycor():
    _tscheme_prep()
    return turtle.ycor()

@primitive("pos")
def scheme_turtle_pos():
    _tscheme_prep()
    return turtle.pos()
